...
![DataStructures](./PerformanceComparison/DataStructure.png)

- Removed operations directly over JSON, now all data structures are C++ native.
![Operations](./PerformanceComparison/Operations.png)
...
![Values](./PerformanceComparison/Values.png)
...
## How to read:
In both the [Papy Report](./PerformanceComparison/Before/report_before.txt#L6) and the [PapyLoL Report](./PerformanceComparison/After/report_after.txt#L6) you will see the Samples and event count show the time it took for both programs to run the same command. Which in our case with a difference of:
...
![Deltas](./PerformanceComparison/Graph1.png)
